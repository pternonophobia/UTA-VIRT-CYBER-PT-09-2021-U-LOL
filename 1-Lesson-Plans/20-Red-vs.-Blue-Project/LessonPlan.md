...
**Capstone credentials:** Please do not share these with students. These credentials are used for troubleshooting purposes only. 
- Username: `ryan`
- Password: `linux4u`
...
<details>
<summary> <b> Click here to view to ELK Server Set Up Instructions </b> </summary>
